            ...
            <?php
                ...
                if(isset($GetPegawai))
                {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="../Views/View_put_pegawai.php?nip=<?php echo base64_encode($Get['nip']) ?>">view</a>
                                <a href="../Views/cek_delete_pegawai.php?nip=<?php echo base64_encode($Get['nip']) ?>">Delete</a>
                                <!-- <a href="../Config/Routes.php?function=cek_delete_pegawai&nip=<?php echo $Get['nip'] ?>">Delete</a> -->
                            </td>
                        </tr>
                        <?php 
                        }
